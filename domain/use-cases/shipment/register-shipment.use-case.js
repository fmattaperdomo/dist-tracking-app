...
exports.RegisterShipment = void 0;
const config_1 = require("../../../config");
const custom_error_1 = require("../../errors/custom.error");
class RegisterShipment {
    constructor(shipmentRepository, signToken = config_1.JwtAdapter.generateToken) {
        this.shipmentRepository = shipmentRepository;
        this.signToken = signToken;
    }
    execute(registerShipmentDto) {
        return __awaiter(this, void 0, void 0, function* () {
            const shipment = yield this.shipmentRepository.register(registerShipmentDto);
            const token = yield this.signToken({ id: shipment.id }, '2h');
            if (!token)
